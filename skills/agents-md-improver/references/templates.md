...
Templates for agent instruction files (CLAUDE.md / AGENTS.md / GEMINI.md). Pick the filename your team's agents actually read; when multiple agents are in use, prefer one real file plus symlinks over duplicated content.
