...
Applies to agent instruction files: CLAUDE.md / AGENTS.md / GEMINI.md and their local/package-level variants.
...
- Content drift between sibling files serving the same role (e.g. a CLAUDE.md and an AGENTS.md that exist as separate files but disagree)
